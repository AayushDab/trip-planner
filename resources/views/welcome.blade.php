...
<div class="space-x-8 mt-5 mb-5">
    ...
    @auth
        ...
        <a href="/my-trips" class="hover:text-blue-400">
            My Trips
        </a>
...
<div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center px-10 relative z-10">
    ...
    <div>
        ...
        <div class="flex gap-5">
            ...
            <a href="/trip"
            class="bg-blue-500 hover:bg-blue-600 px-8 py-4 rounded-2xl text-lg font-bold transition duration-300 hover:scale-105 shadow-xl shadow-blue-500/30">
            ...
            <a href="#features"
            class="border border-white/20 backdrop-blur-lg px-8 py-4 rounded-2xl hover:bg-white hover:text-black transition duration-300">
...
<div class="bg-white/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8 w-full max-w-md shadow-2xl relative overflow-hidden">
    ...
    <div class="space-y-5">
        ...
        <div class="bg-white/5 border border-white/10 p-5 rounded-2xl hover:scale-105 transition">
    ...
    <div class="grid md:grid-cols-3 gap-10">
        ...
        <div class="bg-white/5 p-8 rounded-3xl border border-white/10 hover:scale-105 transition">
            ...
            <p class="text-gray-300">
                Generate complete day-wise trip plans using AI.
            </p>
        ...
        <div class="bg-white/5 p-8 rounded-3xl border border-white/10 hover:scale-105 transition">
            ...
            <p class="text-gray-300">
                Calculate smart travel budgets automatically.
            </p>
